    ...
    return (
        < tr className={transaction.expenseType > 0 ? 'minus' : 'plus'}>
            ...
            <td>
                ...
                <PopupExample trigger1={<svg onClick={() => editTransaction(transaction)} width="1em" height="1em" viewBox="0 0 16 16" className="bi bi-pencil-fill edit-btn" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
